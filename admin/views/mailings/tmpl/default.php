...
<form action="<?php echo JRoute::_('index.php?option=com_bixmailing&view=mailings'); ?>" method="post" name="adminForm" id="adminForm" class="uk-form">
	<div class="uk-grid">
				...
				<table class="uk-table uk-table-hover uk-table-striped uk-table-condensed">
					<thead>
						<tr>
							...
							<th align="left">
							<?php echo JHtml::_('grid.sort',  'BIX_MAILING_NAAM', 'm.naam', $listDirn, $listOrder); ?>
							</th>

							<th align="left">
							<?php echo JHtml::_('grid.sort',  'BIX_MAILING_USERID', 'vmi.company', $listDirn, $listOrder); ?>
							</th>

							<th align="left">
							<?php echo JHtml::_('grid.sort',  'BIX_MAILING_TYPE', 'm.type', $listDirn, $listOrder); ?>
							</th>

							<th align="left">
							<?php echo JHtml::_('grid.sort',  'BIX_MAILING_STATUS', 'm.status', $listDirn, $listOrder); ?>
							</th>
					...
					foreach ($this->items as $i => $item) :
						...
						<tr class="row<?php echo $i % 2; ?>">
							...
							<?php if (isset($item->checked_out) && $item->checked_out) : ?>
								<?php echo JHtml::_('jgrid.checkedout', $i, $item->editor, $item->checked_out_time, 'mailings.', $canCheckin); ?>
							<?php endif; ?>
							<?php if ($canEdit) : ?>
								<a href="<?php echo JRoute::_('index.php?option=com_bixmailing&task=mailing.edit&id='.(int) $item->id); ?>">
							...
							<?php if (isset($this->items[0]->state)) { ?>
								<td class="center">
									<?php echo JHtml::_('jgrid.published', $item->state, $i, 'mailings.', $canChange, 'cb'); ?>
								</td>
							<?php } ?>
							<?php if (isset($this->items[0]->id)) { ?>
							<td class="center">
