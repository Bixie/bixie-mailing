	...
	<?php if (count($this->mailLogs)) : ?>
		...
		<?php foreach ($this->mailLogs as $mailLog) : ?>
			<li class="uk-clearfix">
				<a class="uk-button uk-float-right" title="<?php echo JText::_('COM_BIXMAILING_MAILLOG_DETAILS'); ?>" href="#details-maillog-<?php echo $mailLog->id; ?>" data-uk-modal><i class="uk-icon-search"></i></a>
				<div class="uk-text-truncate">
					<?php echo $mailLog->onderwerp; ?><br/>
					<strong><?php echo JText::_('COM_BIXMAILING_MAILLOG_VERZONDEN'); ?>:</strong> <?php echo JHtml::_('date',$mailLog->created,'D d M Y H:i:s'); ?>
				</div>
