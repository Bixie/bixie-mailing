...
/**
 * Class BixmailingControllerMassa
 */
class BixmailingControllerMassa extends JControllerForm {
	...
	/**
	 * Creeer massanaam obv mailinggegevens
	 * @return void
	 */
	public function renderMassaNaam () {
		$return = array(
			'success' => false,
		...
		$return['result']['naam'] = $model->renderMassaNaam($mailing_id, $user_id, $type, $return['messages']);
