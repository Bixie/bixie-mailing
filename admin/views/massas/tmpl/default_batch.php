				...
				<div class="uk-grid">
					<div class="uk-width-1-4">
						...
						<div data-uk-switcher="{connect:'#batch-panels'}" data-batch-type>
							<button type="button" class="uk-button uk-display-block uk-width-1-1 uk-active"
									data-batch-type="mail">
								<i class="uk-icon-envelope-o uk-margin-small-right"></i><?php echo JText::_('COM_BIXMAILING_MAILINGS_BATCH_MAIL'); ?>
							</button>
							<button type="button" class="uk-button uk-display-block uk-width-1-1"
									data-batch-type="status">
									...
									<div class="uk-grid">
										<div class="uk-width-medium-1-3">
											<div class="uk-form-row">
												<label
													class="uk-form-label"><?php echo JText::_('COM_BIXMAILING_MAILINGS_MAILTEMPLATE'); ?></label>
												...
												<div
													...
													<button id="load-template" class="uk-button uk-button-small"
															type="button"><i class="uk-icon-refresh"></i></button>
												</div>
												<ul class="uk-list">
													<?php if ($this->mailTemplates) : ?>
														<?php foreach ($this->mailTemplates as $mailTemplate) :
															...
															<li data-template-type="<?php echo $mailTemplate->type; ?>"<?php echo $hidden; ?>>
																...
																<div
																	class="content uk-hidden"><?php echo $mailTemplate->content; ?></div>
															</li>
														<?php endforeach; ?>
													<?php endif; ?>
												</ul>
										...
										<div class="uk-width-medium-2-3">
											<div class="uk-text-right uk-margin-bottom">
												...
												<button type="submit" class="uk-button uk-button-primary"
														onclick="Joomla.submitbutton('mailing.batch');"
														id="bix-sendmail">
											...
											<div id="template-editor" class="uk-hidden">
												<div class="uk-form-row">
													<label
														class="uk-form-label"><?php echo JText::_('BIX_MAILING_TEMPLATE_ONDERWERP'); ?></label>

													<div class="uk-form-controls"><input name="batch[subject]"
																						 type="text" value=""
