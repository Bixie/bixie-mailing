...
if ($this->state->get('vervoerder', '') != 'postnl') {
	?>
...
<div class=" uk-margin-bottom" data-bix-mailing-incompleet="{vervoerder:'postnl'}">
...
<div data-bix-klantrecords="<?php echo $currentKlantnummer; ?>-postnl" class="uk-margin-bottom">
	<?php else : ?>
	<div class="bix-controls uk-margin-bottom"
		 data-bix-klantcontrols="{klantnummer:'<?php echo $currentKlantnummer; ?>',user_id:<?php echo $bixMailing->user_id; ?>,vervoerder:'postnl'}">
		...
		<div class="uk-grid">
			<div class="uk-width-1-2 uk-form">
				<label class="">
					<input type="checkbox" class="uk-margin-small-right" name="klantmailer[]"
						   value="<?php echo $bixMailing->id; ?>" checked="checked"/>
			...
			<div class="uk-width-1-2">
				<div class="uk-margin-small-top">
					...
					<div
						class="bix-nractivemailings uk-badge uk-badge-notification uk-badge-success uk-float-right uk-margin-right">
					</div>
				</div>
			</div>
		</div>
	</div>
	<div data-bix-klantrecords="<?php echo $currentKlantnummer; ?>-postnl" class="uk-margin-bottom" hidden>
		<?php endif; ?>
		<?php else : ?>
			<hr/>
		<?php
			...
			<div class="uk-width-1-3 uk-text-truncate">
				...
				<?php else : ?>
					<button class="uk-button"
							data-bix-selectuser-button="{mailingID:<?php echo $bixMailing->id; ?>,vervoerder:'postnl',referentie:'<?php echo $bixMailing->referentie; ?>'}">
